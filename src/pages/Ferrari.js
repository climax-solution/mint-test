    ...
    return (
        <>
            ...
            <div className="container">
                <div className="row">
                    <h2 style={{fontWeight: "700"}} className="mt-5 mb-3 col-sm-12 col-lg-7"><strong>Lock or Unlock Coins</strong></h2>
                </div>
                ...
                <div className="col-sm-12 col-lg-5">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">
                                    <strong>Create mint request</strong>
                                </h5>
                                <fieldset id="createTransferFieldset">
                                    <button type="button" className="btn btn-success w-100 mb-1" id="transferCreateButton"><b>Press to request Coin Un/Lock</b></button>
                                </fieldset>
                    ...
                    <div className="col-sm-12 col-lg-5">
                        <div className="card">
                            <div className="card-body">
                                <fieldset id="createTransferFieldset">
                                    <label htmlFor="createTransferToAddress"><b>Coin Un/Lock Request</b></label>
                                ...
                                <fieldset id="createTransferFieldset">
                                    <label htmlFor="createTransferToAddress"><b>Created By</b></label>
                                    <div className="input-group mb-3">
                                        <input type="text" className="htmlForm-control w-100" placeholder="" aria-label=""
                                            id="createTransferToAddress" />
                                    </div>
            ...
            <div className="container">
                <div className="row">
                    <h2 className="mt-5 mb-3 col-sm-12 col-lg-7"><strong>Transfer Coins</strong></h2>
                </div>
                <div className="row justify-content-center">
                <div className="col-sm-12 col-lg-5">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <fieldset id="createTransferFieldset">
                                    ...
                                    <div className="input-group mb-3">
                                        <input type="text" className="htmlForm-control w-100" placeholder="" aria-label="Address"
                                            id="createTransferToAddress" />
                                    </div>
                    ...
                    <div className="col-sm-12 col-lg-5">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">
                                    <strong>Currennt mint request</strong>
                                </h5>
                                <fieldset id="createTransferFieldset">
            ...
            <div className="container">
                <div className="row">
                    <h2 className="mt-5 mb-3 col-sm-12 col-lg-7"><strong>Mint New Coins</strong></h2>
                </div>
                <div className="row justify-content-center">
                <div className="col-sm-12 col-lg-5">
                        <div className="card">
                    ...
                    <div className="col-sm-12 col-lg-5">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">
                                    <strong>Create  a Request to Burn Cooins</strong>
                                </h5>
                                <fieldset id="createTransferFieldset">
                                    <label htmlFor="createTransferToAddress">To address</label>
                                    <div className="input-group mb-3">
            ...
            <div className="container">
                <div className="row">
                    <h2 className="mt-5 mb-3 col-sm-12 col-lg-7"><strong>Burn Coins</strong></h2>
                </div>
                <div className="row justify-content-center">
                <div className="col-sm-12 col-lg-5">
                        <div className="card">
